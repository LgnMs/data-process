...
export async function collect_task_info_day_list(payload: CollectTaskInfoDayListReq): Promise<ResJson<CollectTaskInfoRes>> {
...
export async function sharing_task_info(payload: SharingTaskInfoReq): Promise<ResJson<SharingTaskInfoRes>> {
...
export async function sync_task_info(payload: SyncTaskInfoReq): Promise<ResJson<SyncTaskInfoRes>> {
