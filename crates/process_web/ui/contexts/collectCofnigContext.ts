...
export type CollectConfigAction =
  | {
      ...
      pagination: CollectConfigState["pagination"];
    }
  | {
      type: "collectConfig.setEditFormOpen";
      editFormOpen: CollectConfigState["editFormOpen"];
    }
  | {
      type: "collectConfig.setEditFormData";
      editFormData: CollectConfigState["editFormData"];
    };

export function CollectConfigReducer(
  state: CollectConfigState,
  action: CollectConfigAction
) {
